    ...
    <div className="p-6">
        ...
        <div className="relative overflow-hidden bg-zinc-900 rounded-[2rem] p-8 border border-zinc-800 mb-8 aspect-[4/3] flex flex-col justify-end group active:scale-[0.98] transition-transform">
            ...
            <div className="relative z-10">
                <span className="bg-accent-pink text-white text-[10px] font-black px-2 py-0.5 rounded-full uppercase tracking-wider mb-2 inline-block">Bloc du moment</span>
                <h2 className="text-3xl font-black mb-1">Dyno de la Mort</h2>
                <p className="text-zinc-400 text-sm">Par Alex • 7A+ • 45 Likes</p>
            </div>
        </div>
...
const BottomNav = () => {
    ...
    // Hide nav on create page to give more space for canvas
